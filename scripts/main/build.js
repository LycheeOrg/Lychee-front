...
build.getAlbumThumb = function (data, i) {
	...
	return `<span class="thumbimg${isVideo ? ' video' : ''}"><img class="lazyload" src="dist/images/placeholder.png" data-src='${thumb}' ${(thumb2x !== '') ? 'srcset=\'' + thumb2x + ' 2x\'' : ''} alt='Photo thumbnail' data-overlay='false' draggable='false'></span>`
};
