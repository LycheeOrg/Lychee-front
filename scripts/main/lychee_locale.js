...
lychee.locale = {
	...
	DELETE_ALBUMS_CONFIRMATION:
		"Are you sure you want to delete all %0 selected albums and all of the photos they contain? This action can't be undone!",
	...
	PHOTOS_NEW_TAGS:
		"Enter your tags for all %0 selected photos. Existing tags will be overwritten. You can add multiple tags by separating them with a comma:",
	...
	ABOUT_DESCRIPTION:
		"<a target='_blank' href='%0'>Lychee</a> is a free photo-management tool, which runs on your server or web-space. Installing is a matter of seconds. Upload, manage and share photos like from a native application. Lychee comes with everything you need and all your photos are stored securely.",
